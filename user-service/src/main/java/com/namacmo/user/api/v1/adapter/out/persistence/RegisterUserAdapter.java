...
import com.namacmo.user.api.v1.adapter.out.persistence.entity.AddressJpaVo;
import com.namacmo.user.api.v1.adapter.out.persistence.entity.UserJpaEntity;
import com.namacmo.user.api.v1.adapter.out.persistence.reposirot.UserJpaRepository;
