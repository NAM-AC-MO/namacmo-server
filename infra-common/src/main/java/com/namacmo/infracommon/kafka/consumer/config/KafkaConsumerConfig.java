package com.namacmo.infracommon.kafka.consumer.config;

import com.namacmo.infracommon.kafka.config.KafkaConfigData;
import com.namacmo.infracommon.kafka.config.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> consumerConfigs() {
        log.info("KafkaConsumerConfig -> kafkaConfigData={} kafkaConsumerConfigData={}", kafkaConfigData, kafkaConsumerConfigData);
